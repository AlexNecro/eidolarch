...
const SHELL=['/','/assets/app.css?v=2.2.9','/assets/app.js?v=2.2.9','/assets/viewer.js?v=2.2.9','/assets/settings.js?v=2.2.9','/manifest.json?v=2.2.9','/assets/icons/app-mark.svg?v=2.2.9'];

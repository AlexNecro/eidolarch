const CACHE='eidolarch-shell-v230';
const SHELL=['/','/assets/app.css?v=2.3.0','/assets/app.js?v=2.3.0','/assets/viewer.js?v=2.3.0','/assets/settings.js?v=2.3.0','/manifest.json?v=2.3.0','/assets/icons/app-mark.svg?v=2.3.0'];
